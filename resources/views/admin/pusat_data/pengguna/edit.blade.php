        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('admin.pengguna.update', $user->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            @if($user->photo_path)
                                <div class="mt-2 mb-2">
                                    <img src="{{ asset('storage/' . $user->photo_path) }}" alt="Current Photo" class="h-20 w-20 rounded-full object-cover">
                                </div>
                            @endif
